...
public class MyArrayList<E> {
     ...
     * @param initialCapacity starting capacity of MyArrayList
     */
     ...
     * index is greater than size or less than 0
     */
     ...
     * @param index index of object to be changed
     * @param obj the new object that will replace the old object
     ...
     * @param fromIndex starting index of range
