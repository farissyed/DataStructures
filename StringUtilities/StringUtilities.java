...
public class StringUtilities {
     ...
     * @return A new String with all values reversed between index from (inclusive)
     *         and to (exclusive)
     * @throws NullPointerException
     *             if the original String is null
    ...
    /**
     * Determines if the String itself is storing a number. A number can start with
     * a negative sign (-), may contains one period (.), and otherwise is made only
     * of digits from 0-9.
     * 
    ...
    /**
     * Counts the number of characters which have the same value next to them. ie:
